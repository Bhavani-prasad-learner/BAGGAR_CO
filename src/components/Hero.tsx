...
const Hero: React.FC = () => {
  ...
  return (
    ...
    <div className="relative flex items-center justify-center overflow-hidden min-h-screen bg-brand-mesh-premium">
        ...
        <div className="max-w-4xl">
          <div className="flex flex-col justify-center items-center md:scale-[135%] md:mb-10">
            ...
            <motion.a
              ...
              href="#menu"
              className="z-30 w-max py-3 px-10 tracking-wide font-semibold text-2xl text-center"
            >
              <span 
            ...
            <motion.a
              ...
              transition={{ duration: 0.8, delay: 0.4, ease: "easeOut" }}
              href="#menu"
              className="z-30 w-max px-10 tracking-wide font-thin text-white hover:text-[#DFBA6B] transition-colors text-sm text-center"
            >
